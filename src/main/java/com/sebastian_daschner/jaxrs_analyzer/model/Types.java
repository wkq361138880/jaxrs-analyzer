...
public final class Types {
	...
	public static final Set<String> PRIMITIVE_TYPES = new HashSet<>(
			Arrays.asList(PRIMITIVE_BOOLEAN, PRIMITIVE_VOID, PRIMITIVE_CHAR, PRIMITIVE_INT, PRIMITIVE_LONG,
					PRIMITIVE_SHORT, PRIMITIVE_BYTE, PRIMITIVE_DOUBLE, PRIMITIVE_FLOAT));
	public static final Set<String> PRIMITIVE_TYPES_ALL = new HashSet<>(Arrays.asList(PRIMITIVE_BOOLEAN, BOOLEAN,
			PRIMITIVE_VOID, PRIMITIVE_CHAR, CHARACTER, PRIMITIVE_INT, INTEGER, PRIMITIVE_LONG, LONG, PRIMITIVE_SHORT,
			SHORT, PRIMITIVE_BYTE, BYTE, PRIMITIVE_DOUBLE, DOUBLE, PRIMITIVE_FLOAT, FLOAT));
	public static final Set<String> INTEGER_TYPES = new HashSet<>(Arrays.asList(INTEGER, PRIMITIVE_INT, BIG_INTEGER,
			LONG, PRIMITIVE_LONG, SHORT, PRIMITIVE_SHORT, BYTE, PRIMITIVE_BYTE));
	public static final Set<String> DOUBLE_TYPES = new HashSet<>(
			Arrays.asList(DOUBLE, PRIMITIVE_DOUBLE, FLOAT, PRIMITIVE_FLOAT, BIG_DECIMAL));
